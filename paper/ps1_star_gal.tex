...
\begin{figure*}[htb]
 \centering
  ...
  the SDSS and PS1 models. \todo{fix alpha for bottom KDE, add legend for
  KDEs}}
  %
  \label{fig:acc_sdss}
\end{figure*}
...
interesting trends: as was the case prior to correction all 4 models perform similarly well for bright (\texttt{whiteKronMag}
$\lesssim 20\,\mathrm{mag}$) sources. However, for fainter sources the RF
and simple models significantly outperform the SDSS and PS1 models. The bottom panel
