...
\label{tbl:fpr}}
    ...
    \startdata
\multirow{2}{*}{All sources} & \multirow{2}{*}{35,007} & \multirow{2}{*}{$93.9\pm0.1$\%} &                     TPR  & $0.734^{+0.012}_{-0.014}$ & $0.792^{+0.010}_{-0.009}$ & $0.843\pm0.008$ & $0.904\pm0.005$ & $0.947\pm0.004$  \\
...
\multirow{2}{*}{$\mathtt{rKronMag} < 20$}  & \multirow{2}{*}{6,956}& \multirow{2}{*}{$99.0\pm0.1$\%} &
                                              TPR  & $0.697^{+0.197}_{-0.219}$ & $0.954^{+0.038}_{-0.082}$ & $0.994\pm0.002$ & $0.997\pm0.002$ & $0.998\pm0.001$   \\
                                                 & &  & Threshold & $0.993^{+0.005}_{-0.015}$ & $0.923^{+0.052}_{-0.328}$ & $0.339^{+0.082}_{-0.050}$ & $0.132^{+0.036}_{-0.021}$ & $0.047^{+0.006}_{-0.005}$
    \enddata
    \tablecomments{10-fold CV is performed on the entire \textit{HST} training set, but the metrics reported here include only sources that satisfy the selection criteria defined by the first column and $\mathtt{nDetections} \ge 3$. The reported uncertainties for the TPR and classification threshold represent the central 90\% interval from 100 bootstrap resamples of the training set, \NC{ while best values are for the entire \textit{HST} training set in each selection criteria.}} 
