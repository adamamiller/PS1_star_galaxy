...
\begin{figure}[t]
 \centering
  \includegraphics[width=3.5in]{./Figures/whiteFeatures.pdf}
  \caption{\yutaro{details for this caption: (i) what colors means, (ii) how whiteKronMag is defined, (iii) what the contours represent, (iv) the meaning of the different KDE PDF estimates.}}
  %
  \label{fig:features}
\end{figure}
