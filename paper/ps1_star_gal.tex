...
\citep{Lindegren18}. While some of these $\sim$2$\times10^7$ sources may be at a
...
full distribution of parallax significance for these faint
sources we find the 99.997-th percentile (roughly 4$\sigma$ for a Gaussian
distribution) corresponds to 7.94. Thus, we apply
\textit{conservative cuts} to the parallax significance of $\ge$8 and to select
bonafide stars from the \textit{Gaia} data.
