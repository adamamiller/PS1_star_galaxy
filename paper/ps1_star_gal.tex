...
\begin{figure}[t]
 \centering
  \includegraphics[width=3.35in]{./Figures/ROC_curves.pdf}
  %
...
with $z < 10^{-4}$ (= 13261 sources; such low $z$ is only expected in the
...
\begin{figure*}[htb]
 \centering
  ...
  the SDSS and PS1 models.} \todo{fix alpha for bottom KDE}
  %
  \label{fig:acc_sdss}
\end{figure*}
%%%%%%%%%%%%%
...
blended in imaging data. The bias correction further shows that the PS1
