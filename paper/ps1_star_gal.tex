...
\begin{deluxetable}{cccc}
    ...
    \startdata
    RF & \textbf{0.843} & 0.963  & \textbf{0.987}  \\
    simple & 0.798  & 0.956 & 0.985 \\
    PS1 & 0.290 & 0.900 & 0.984 \\
    SDSS & 0.777 & \textbf{0.971} & \textbf{0.987} \\
    \enddata
    \tablecomments{Uncertainties are not reported because the SDSS test set is independent of the training methods for these 4 models. \yutaro{I'm wondering if we should create 100 bootstrap samples of the SDSS test set and report the stats for that?}} 
...
\label{tbl:fpr}}
    \tablehead{ 
    \colhead{Selection criteria} & \colhead{$N$\tablenotemark{a}} & \colhead{Accuracy\tablenotemark{a}} & \colhead{FPR} & \colhead{0.005} & \colhead{0.01} & \colhead{0.02} & \colhead{0.05} & \colhead{0.1}
    }
    \startdata
