...
\label{tbl:fpr}}
    ...
    \startdata
\multirow{2}{*}{All sources} & \multirow{2}{*}{35,007} & \multirow{2}{*}{$93.9\pm0.1$\%} &                     TPR  & $0.729^{+0.014}_{-0.009}$ &  $0.793^{+0.008}_{-0.005}$ & $0.842^{+0.006}_{-0.004}$ & $ 0.905^{+0.003}_{-0.003}$ & $0.946^{+0.003}_{-0.002}$ \\
\multicolumn{1}{l}{}                 & & & Threshold & $0.837^{+0.009}_{-0.023}$ &  $0.720^{+0.012}_{-0.015}$ & $0.601^{+0.007}_{-0.012}$ & $0.393^{+0.006}_{-0.006}$ & $0.224^{+0.005}_{-0.003}$
\\ \hline
\multirow{2}{*}{$\mathtt{rKronMag} < 21$} & \multirow{2}{*}{13,570} & \multirow{2}{*}{$98.0\pm0.1$\%} &
                                              TPR  & $0.772^{+0.114}_{-0.058}$ &  $0.964^{+0.005}_{-0.004}$ & $0.979^{+0.003}_{-0.002}$ & $0.989^{+0.001}_{-0.001}$ & $0.995^{+0.001}_{-0.001}$ \\
                                                & & & Threshold & $0.975^{+0.008}_{-0.044}$ &  $0.653^{+0.042}_{-0.049}$ & $0.416^{+0.032}_{-0.043}$ & $0.173^{+0.010}_{-0.011}$ & $0.068^{+0.004}_{-0.002}$   \\ \hline
\multirow{2}{*}{$\mathtt{rKronMag} < 20$}  & \multirow{2}{*}{6,956}& \multirow{2}{*}{$99.0\pm0.1$\%} &
                                              TPR  & $0.634^{+0.228}_{-0.021}$ &  $0.955^{+0.032}_{-0.072}$ & $0.994^{+0.002}_{-0.001}$ & $0.994^{+0.002}_{-0.001}$ & $0.998^{+0.001}_{-0.001}$  \\
                                                 & &  & Threshold & $0.9952^{+0.0004}_{-0.0155}$ &  $0.923^{+0.051}_{-0.290}$ & $0.315^{+0.087}_{-0.021}$ & $0.132^{+0.020}_{-0.016}$ & $0.048^{+0.002}_{-0.002}$
    \enddata
    \tablecomments{10-fold CV is performed on the entire \textit{HST} training set, but the metrics reported here include only sources that satisfy the selection criteria defined by the first column and $\mathtt{nDetections} \ge 3$. The reported uncertainties for the TPR and classification threshold represent the central 68\% interval from \yutaro{NNN} bootstrap resamples of the training set.} 
