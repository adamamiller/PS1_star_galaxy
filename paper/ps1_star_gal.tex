...
\NC{
Combining with the increasing of the amount of information for each source, 
the assessment of the classifier learned with the use of an alternative ensemble learning algorithm 
(e.g., adaptive boosting algorithm; AdaBoost, \citealt{Freund97}) 
would be meaningful to ascertain and boost the power of the star--galaxy separation \citep{Sevilla18}. 
}
