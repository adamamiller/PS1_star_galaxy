\begin{deluxetable*}{l|lccccc}
    ...
    \hline
    \multirow{2}{*}{This work} & TPR & 0.684$^{+0.005}_{-0.005}$ & 0.730$^{+0.004}_{-0.005}$ & 0.772$^{+0.004}_{-0.004}$ & 0.833$^{+0.004}_{-0.003}$ & 0.902$^{+0.004}_{-0.004}$\\
     & FPR & 0.005$^{+0.001}_{-0.000}$ & 0.009$^{+0.001}_{-0.001}$ & 0.016$^{+0.001}_{-0.001}$ & 0.041$^{+0.002}_{-0.001}$ & 0.111$^{+0.002}_{-0.003}$\\
    \enddata
