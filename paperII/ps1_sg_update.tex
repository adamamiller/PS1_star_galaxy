...
presented in \S\ref{sec:ps1psc_update}. \todo{Add sentence about Frank about
...
details of newly discovered variability 
...
``detection'' criteria (see \S\ref{}) and are now included in the PS1 PSC. The
remaining $\sim$281 million sources do not have reliable photometry in either
the PS1 forced or stack tables, and as a result remain in the ZTF
...
\url{https://outerspace.stsci.edu/display/PANSTARRS/PS1+DR2+caveats\#PS1DR2caveats-Missingdata} for more information.}
